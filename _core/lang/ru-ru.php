...
$S_HOME = 'Главная';                                               //Forwards to home page
$S_ADMIN = 'Упраление';                                            //Forwards to Management Panel
$S_RETURN = 'Назад';                                           //Returns to image board
$S_POSTING = 'Ой.';                             //Prints message in red bar atop the reply screen
$S_NOTAGS = 'HTML tags are allowed.';                           //Prints message on Management Board
$S_NAME = 'Имя';                                               //Describes name field
$S_EMAIL = 'E-mail';                                            //Describes e-mail field
$S_SUBJECT = 'Тема';                                         //Describes subject field
$S_SUBMIT = 'Отправить';                                           //Describes submit button
$S_COMMENT = 'Комментарий';                                         //Describes comment field
$S_UPLOADFILE = 'Файл';                                         //Describes file field
$S_NOFILE = 'Без Файла';                                          //Describes file/no file checkbox
$S_DELPASS = 'Password';                                        //Describes password field
$S_DELEXPL = ' (For file deletion)';               //Prints explanation for password box (to the right)
$temp = '<ul><li>Поддерживаемые тип файлов: GIF, JPG, PNG</li>';
if (GIF_ONLY)   $temp = '<ul><li>Поддерживаемые тип файлов: GIF</li>';
$S_RULES = $temp . '<li>Максимальный размер файлов '.MAX_KB.' KB.</li>';
...
$S_REPORTERR = '404.';                     //Returns error when a reply (res) cannot be found
$S_THUMB = '';                                                  //Prints instructions for viewing real source
$S_PICNAME = 'Файл: ';                                         //Prints text before upload name/link
$S_REPLY = 'Ответ';                                             //Prints text for reply link
$S_OLD = 'Marked for deletion (old).';                          //Prints text to be displayed before post is marked for deletion, see: retention
$S_RESU = '';                                                   //Prints post?
$S_ABBR = ' постов свернуто. Нажмите <a href="thread/" class="replylink">здесь</a> чтобы развернуть';               //Prints text to be shown when replies are hidden
